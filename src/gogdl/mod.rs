...
impl GogDl {
    ...
    pub async fn get_game_details(&self, game_id: i32) -> Result<GameDetails, GogdlError> {
        ...
        if let Some(auth) = auth.as_ref() {
            let game_details = crate::games::get_game_details(
                auth,
                &self.client,
                game_id,
    ...
    pub async fn get_owned_games(&self) -> Result<Vec<GameDetails>, GogdlError> {
        ...
        if let Some(auth) = auth.as_ref() {
            let games = crate::games::get_owned_games(
                &auth,
                &self.client,
    ...
    pub async fn get_game_builds(
        ...
        if let Some(auth) = auth.as_ref() {
            let game_builds = crate::games::get_game_builds(
                auth,
                &self.client,
                game_id,
                os,
    ...
    pub async fn get_build_metadata(
        ...
        if let Some(auth) = auth.as_ref() {
            let build_metadata = crate::games::get_build_metadata(
                auth,
                &self.client,
                game_id,
                os,
    ...
    pub async fn get_build_files(
        ...
        if let Some(auth) = auth.as_ref() {
            let depot_files = crate::games::get_build_files(
                auth,
                &self.client,
                game_id,
                os,
    ...
    pub async fn download_build(
        ...
        if let Some(auth) = auth.as_ref() {
            let res = crate::games::download_game(
                auth,
                &self.client,
                game_id,
                os,
    ...
    pub async fn verify_and_repair_build(
        ...
        if let Some(auth) = auth.as_ref() {
            let summary = crate::games::verify_and_repair_build(
                auth,
                &self.client,
                game_id,
                os,
    ...
    pub async fn cleanup_build(
        ...
        if let Some(auth) = auth.as_ref() {
            let summary = crate::games::cleanup_build(
                auth,
                &self.client,
                game_id,
                os,
    ...
    pub async fn estimate_download(
        ...
        if let Some(auth) = auth.as_ref() {
            let estimate = crate::games::estimate_download(
                auth,
                &self.client,
                game_id,
                os,
    ...
    pub async fn get_build_chunks(
        ...
        if let Some(auth) = auth.as_ref() {
            let build_chunks = crate::games::get_build_chunks(
                auth,
                &self.client,
                game_id,
                os,
    ...
    pub async fn get_secure_links(&self, game_id: i32) -> Result<SecureLinks, GogdlError> {
        ...
        if let Some(auth) = auth.as_ref() {
            let secure_links = crate::games::get_secure_links(auth, &self.client, game_id).await?;
            Ok(secure_links)
        } else {
            return Err(GogdlError::NotLoggedIn);
        }
    ...
    pub async fn get_remote_config(&self, client_id: &str) -> Result<RemoteConfig, GogdlError> {
        let remote_config = crate::saves::get_remote_config(&self.client, client_id)
            .await
            .map_err(GogdlError::from)?;
        Ok(remote_config)
    }
    pub async fn get_auth_ids(&self, game_id: i32) -> Result<(String, String), GogdlError> {
        ...
        if let Some(auth) = auth.as_ref() {
            let auth_ids = crate::saves::get_auth_ids(
                &self.client,
                game_id,
                auth,
                self.game_details_cache.clone(),
    ...
    pub async fn get_save_file_list(
        ...
        if let Some(auth) = auth.as_ref() {
            let saves_auth = auth
                ...
                .await?;
            let response =
                crate::saves::get_save_files_list(&self.client, client_id, &saves_auth).await?;
            Ok(response)
        } else {
            Err(GogdlError::NotLoggedIn)
        }
    ...
    pub async fn upload_save_file(
        ...
        if let Some(auth) = auth.as_ref() {
            let saves_auth = auth
                .get_cloud_saves_tokens(&self.client, client_id, client_secret)
                .await?;
            crate::saves::upload_file(&self.client, &saves_auth, path, &url_path, tx).await?;
            Ok(())
        } else {
            Err(GogdlError::NotLoggedIn)
        }
    ...
    pub async fn download_save_file(
        ...
        if let Some(auth) = auth.as_ref() {
            let saves_auth = auth
                .get_cloud_saves_tokens(&self.client, client_id, client_secret)
                .await?;
            crate::saves::download_file(save_file, &saves_auth, &self.client, tx, path).await?;
            Ok(())
        } else {
            Err(GogdlError::NotLoggedIn)
        }
    ...
    pub async fn delete_save_file(
        ...
        if let Some(auth) = auth.as_ref() {
            let saves_auth = auth
                .get_cloud_saves_tokens(&self.client, client_id, client_secret)
                .await?;
            crate::saves::delete_save_file(save_file, &saves_auth, &self.client).await?;
            Ok(())
        } else {
            Err(GogdlError::NotLoggedIn)
        }
